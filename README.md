...
- Карусель товаров (◀ позиция ▶), зацикленная
- Кнопка «Хочу заказать» с инструкцией и ссылкой в ЛС
- Админка `/admin`: категории, товары, контакты, редактирование полей
...
3. Добавьте товары с фото — бот сохранит `file_id` Telegram
4. Настройте текст «Контакты»
